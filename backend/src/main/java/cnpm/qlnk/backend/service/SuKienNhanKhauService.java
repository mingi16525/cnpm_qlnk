package cnpm.qlnk.backend.service;

import cnpm.qlnk.backend.entity.SuKienNhanKhau;
import cnpm.qlnk.backend.entity.NhanKhau;
import cnpm.qlnk.backend.repository.SuKienNhanKhauRepository;
import cnpm.qlnk.backend.repository.NhanKhauRepository;
